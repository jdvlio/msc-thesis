...
\end{thm}
\begin{proof}
	Near-identical to the proof of Theorem \ref{thm:Cll}, the only variation being that one invokes Proposition \ref{prp:dsum} to obtain an $h$ that induces the required canonical partition of $\reals$ into dense subsets.
\end{proof}
