...
\usepackage[xindy,nopostdot,symbols,nomain,nonumberlist]{glossaries}
\usepackage{stmaryrd}
...
\newcommand{\setbuild}[2]{\lbrace #1\colon #2 \rbrace}
...
\newcommand{\reg}[1]{\mathcal{R}_{#1}}

% AMS-Latex customisation
\newcommand{\noqed}{\renewcommand{\qedhere}{\phantom{}}}
...
\begin{document}
   ...
   % frontmatter
	...
	\include{prelim/pre}
	\include{ramtheory/ramsey}
	\include{scattered/scatter}
	\include{mono/mono}
	\include{complete/comp}
	\include{suslin/suslin}
	\include{cont/cont}

	% backmatter
	\appendix
	\include{computability/comp}
