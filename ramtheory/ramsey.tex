...
The arrows of $\cat{M}$, i.e.\ the monoid elements, then represent
what we have referred to as "colours" with $\circ$ corresponding simultaneously
to the aforementioned $\oplus$ operation and multiplication within the monoid
itself.
