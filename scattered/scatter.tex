...
\begin{prp}
         Suppose $f\colon\alpha\to\beta$ is a sptitting then there exists a unique congruence relation $\sim$ on $\alpha$ such that, if $\pi\colon\alpha\to\faktor{\alpha}{\sim}$ is the splitting induced by $\sim$, there exists a unique isomorphism $\iota\colon\faktor{\alpha}{\sim}\to\beta$ making the diagram
        \begin{equation}
            \begin{tikzcd}
