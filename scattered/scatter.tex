...
\begin{dfn}[Congruence formula]
	...
	$a_\varphi=\faktor{a}{\varphi}$ will mean the equivalence class $\faktor{a}{\sim}$.
\end{dfn}
...
\begin{prp}
	...
	\begin{enumerate}
		...
		\item   there exists no dense linear order $\delta$ and no $n\in\nats$
			such that, for some $\bar{b}\in\domain{n}\delta$ and
			$\bar{a}\in\domain{n}\alpha$, $(\delta,\bar{b})$ is interpretable in
			$(\alpha,\bar{a})$,
