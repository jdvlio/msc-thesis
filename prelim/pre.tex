...
\begin{dfn}[Interpretation]
	...
	\begin{enumerate}
		...
		\item	if $k\in\nats$ and $\varphi=\varphi(x_0,\dotsc,x_{k+1})$ then it necessarily follows that $\Gamma(\exists x_k\varphi)$ is the formula
			\begin{equation}
