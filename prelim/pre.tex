...
\begin{dfn}[Proof sequence]
	Suppose $L$ is a finitary first-order language and let $T$ be an $L$-theory.  If $\mathcal{S}$ is a recursively enumerable class of regular expansions of models of $T$ then a \textbf{proof sequence} over $\mathcal{S}$ is a finite sequence of pairs $(\mathfrak{M}_0,\sigma_0),\dotsc,(\mathfrak{M}_{n-1},\sigma_{n-1})$ such that, for each $i<n$, $\mathfrak{M}_i\in\mathcal{S}$ and one of the following holds:
	\begin{enumerate}
